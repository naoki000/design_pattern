package com.designpattern.basic.abstractfactory.code;
...
public class Main extends AbsMainCode {
    ...
    protected void main() {
        ...
        //簡単に別の工場を作ることができる！！
//        Factory factory = Factory.getFactory("com.designpattern.basic.abstractfactory.code.listfactory.ListFactory");
        Factory factory = Factory.getFactory("com.designpattern.basic.abstractfactory.code.tablefactory.TableFactory");
